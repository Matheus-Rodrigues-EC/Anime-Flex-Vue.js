    ...
    <div class="container">
        ...
        <div class="tabela">
            ...
            <div> 
                ...
                <div class="lista">
                    <button @click="this.$router.push('/FormAnime');">Adicionar Anime</button>
                    <button @click="this.$router.push('/FormSeason');">Adicionar Temporada</button>
                    <button @click="this.$router.push('/FormEpisode');">Adicionar Episódio</button>
                </div>
            </div>
            <div>
